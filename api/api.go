...
func (a Api) Router() *gin.Engine {
	...
	router.POST("/brokerage/instruments", a.SetInstrumentSettings)
	router.GET("/brokerage/instruments/:instrument", a.GetInstrumentSettings)
	router.POST("/brokerage/positions", a.CreatePosition)
	router.GET("/brokerage/positions/active", a.GetActivePosition)
	router.GET("/brokerage/positions/tradable", a.GetTradablePosition)
	router.POST("/brokerage/trades", a.BookTrade)
	router.POST("/brokerage/sell-trades", a.SellTrade)
